...
Hookify creates rule files that integrate with Factory Droid's hook system to prevent unwanted behaviors.
...
Files are stored as `.factory/hookify.{name}.local.md`:
