...
Create hook rules to prevent unwanted Factory Droid behaviors by analyzing conversation patterns or explicit user instructions.
...
For each approved rule, create a file at `.factory/hookify.{name}.local.md`:
