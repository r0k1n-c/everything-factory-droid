...
Write the full plan document using the template below. Save to `.factory/PRPs/plans/{kebab-case-feature-name}.plan.md`.

Create the directory if it doesn't exist:
```bash
mkdir -p .factory/PRPs/plans
```
...
```
.factory/PRPs/plans/{kebab-case-feature-name}.plan.md
```
...
- **File**: .factory/PRPs/plans/{kebab-case-feature-name}.plan.md
- **Source PRD**: [path or "N/A"]
...
> Next step: Run `/prp-implement .factory/PRPs/plans/{name}.plan.md` to execute this plan.
```
