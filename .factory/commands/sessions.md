---
description: Manage Factory Droid session history, aliases, and session metadata.
---
...
- Sessions are stored as markdown files in `~/.factory/session-data/`
- Aliases are stored in `~/.factory/session-aliases.json`
