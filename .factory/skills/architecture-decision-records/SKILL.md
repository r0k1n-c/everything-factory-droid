...
|-----|-------|--------|------|
| 0001 | Use Next.js as frontend framework | accepted | 2026-01-15 |
| 0002 | PostgreSQL over MongoDB for primary datastore | accepted | 2026-01-20 |
| 0003 | REST API over GraphQL | accepted | 2026-02-01 |
```
