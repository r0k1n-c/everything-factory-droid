...
Analyze token overhead across every loaded component in a Factory Droid session and surface actionable optimizations to reclaim context space.
...
- Check for duplicate copies in `.factory/skills/` — skip identical copies to avoid double-counting
