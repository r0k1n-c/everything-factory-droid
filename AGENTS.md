...
This repository is a production-ready Factory Droid plugin providing 47 specialized agents, 171 skills, 79 commands, and supporting hooks, rules, and MCP configurations.
