...
This resolves the repo's full classified install surface, including all **47 agents**, **178 skills**, and **75 command shims**, plus the shipped template/support assets referenced by those skills.
