...
If you discover a security vulnerability in EFD, please report it responsibly.

**Do not open a public GitHub issue for security vulnerabilities.**

Instead, email [security@efd.tools](mailto:security@efd.tools) with:
