...
1. **Project rules** — Read `AGENTS.md`, `.factory/docs/`, and any contributing guidelines
2. **PRP artifacts** — Check `.factory/PRPs/reports/` and `.factory/PRPs/plans/` for implementation context related to this PR
...
Create review artifact at `.factory/PRPs/reviews/pr-<NUMBER>-review.md`:
...
Artifacts:
  Review: .factory/PRPs/reviews/pr-<NUMBER>-review.md
  GitHub: <PR URL>
