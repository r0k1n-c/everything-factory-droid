...
The script audits the current working directory by default and auto-detects whether the target is the EFD repo itself or a consumer project using EFD.
...
5. Suggested EFD skills to apply next
...
2) [Tool Coverage] Store real project settings in .factory/settings.json and keep hooks in hooks/hooks.json only. (.factory/settings.json)
