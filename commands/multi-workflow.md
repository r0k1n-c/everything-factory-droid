...
- **Droid (self)** – Orchestration, planning, execution, delivery
...
```bash
node scripts/orchestrate-worktrees.js .factory/plan/workflow-e2e-test.json --execute
```
...
**Claude Synthesis**: Adopt Codex backend plan + Gemini frontend plan, save to `.factory/plan/task-name.md` after user approval.
...
2. External models have **zero filesystem write access**, all modifications by Droid
