...
**Output path**: `.factory/PRPs/prds/{kebab-case-name}.prd.md`

Create directory if needed: `mkdir -p .factory/PRPs/prds`
...
**File**: `.factory/PRPs/prds/{name}.prd.md`
...
Run: `/prp-plan .factory/PRPs/prds/{name}.prd.md`
...
└─────────────────────────────────────────────────────────┘
                          ↓
┌─────────────────────────────────────────────────────────┐
│  GENERATE: Write PRD to .factory/PRPs/prds/              │
└─────────────────────────────────────────────────────────┘
```

---

## Integration with EFD
