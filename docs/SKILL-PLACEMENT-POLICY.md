...
| Learned | `~/.factory/skills/learned/` | No | Required |
| Imported | `~/.factory/skills/imported/` | No | Required |
| Evolved | `~/.factory/homunculus/evolved/skills/` (global) or `projects/<hash>/evolved/skills/` (per-project) | No | Inherits from instinct source |
...
- No provenance file. Use `origin` in SKILL.md frontmatter (EFD, community) for attribution.

## Learned Skills

Location: `~/.factory/skills/learned/<skill-name>/`.
...
Location: `~/.factory/skills/imported/<skill-name>/`.
...
Location: `~/.factory/homunculus/evolved/skills/` (global) or `~/.factory/homunculus/projects/<hash>/evolved/skills/` (per-project).
...
`scripts/skills-health.js`, `scripts/lib/skill-evolution/health.js`, session hooks: they probe `~/.factory/skills/learned` and `~/.factory/skills/imported`. Missing directories are treated as empty; no errors.

## Publishable vs Local-Only

| Publishable | Local-Only |
|-------------|------------|
| `skills/*` (curated) | `~/.factory/skills/learned/*` |
| | `~/.factory/skills/imported/*` |
| | `~/.factory/homunculus/**/evolved/**` |
