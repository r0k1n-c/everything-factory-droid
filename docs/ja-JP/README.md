...
> **Factory Droid専用** | **47 agents** | **172 skills** | **75 commands** | **クロスプラットフォーム対応**
...
```
everything-factory-droid/
|-- .factory/         # リポジトリローカルの Factory Droid プロジェクト設定
|   |-- settings.json       # このリポジトリ向けのプロジェクト設定
|   |-- package-manager.json # リポジトリ作業向けの既定パッケージマネージャー
|   |-- identity.json       # プロジェクト識別メタデータ
|   |-- rules/              # リポジトリローカルの Droid ガードレール
|
