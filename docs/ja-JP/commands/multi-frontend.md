...
| フェーズ | Gemini |
|-------|--------|
| 分析 | `~/.factory/.ccg/prompts/gemini/analyzer.md` |
| 計画 | `~/.factory/.ccg/prompts/gemini/architect.md` |
| レビュー | `~/.factory/.ccg/prompts/gemini/reviewer.md` |
...
Claudeが計画を統合し、ユーザーの承認後に`.factory/plan/task-name.md`に保存します。
