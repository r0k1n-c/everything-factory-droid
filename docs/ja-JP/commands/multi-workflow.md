...
| 計画 | `~/.factory/.ccg/prompts/codex/architect.md` | `~/.factory/.ccg/prompts/gemini/architect.md` |
| レビュー | `~/.factory/.ccg/prompts/codex/reviewer.md` | `~/.factory/.ccg/prompts/gemini/reviewer.md` |
...
**Claude統合**: Codexのバックエンド計画 + Geminiのフロントエンド計画を採用し、ユーザーの承認後に`.factory/plan/task-name.md`に保存します。
