---
name: eval-harness
description: Factory Droidセッションの正式な評価フレームワークで、評価駆動開発（EDD）の原則を実装します
tools: Read, Write, Edit, Bash, Grep, Glob
---

# Eval Harnessスキル

Factory Droidセッションの正式な評価フレームワークで、評価駆動開発（EDD）の原則を実装します。
...
```
`.factory/evals/feature-name.md`に評価定義ファイルを作成
