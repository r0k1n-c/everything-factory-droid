# Everything Factory Droid에 기여하기

기여에 관심을 가져주셔서 감사합니다! 이 저장소는 Factory Droid 사용자를 위한 커뮤니티 리소스입니다.
...
# 4. 로컬 테스트
cp -r skills/my-skill ~/.factory/skills/  # 스킬의 경우
# 그런 다음 Factory Droid로 테스트
...
스킬은 Factory Droid가 컨텍스트에 따라 로드하는 지식 모듈입니다.
...
훅은 Factory Droid 이벤트에 의해 트리거되는 자동 동작입니다.
...
이 기여 흐름은 Factory Droid 중심입니다. 저장소에서 명시적으로 다시 도입하지 않는 한 다른 AI 도구 전용 경로를 추가하지 마세요.
