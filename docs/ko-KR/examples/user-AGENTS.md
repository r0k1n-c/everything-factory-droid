...
사용자 수준 AGENTS.md 파일 예제입니다. `~/.factory/AGENTS.md`에 배치하세요.
...
당신은 Factory Droid입니다. 저는 복잡한 작업에 특화된 agent와 skill을 사용합니다.
...
상세 가이드라인은 `~/.factory/rules/`에 있습니다:
