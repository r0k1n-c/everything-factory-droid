# Contribuindo para o Everything Factory Droid

Obrigado por querer contribuir! Este repositório é um recurso comunitário para usuários do Factory Droid.
...
# 4. Testar localmente
cp -r skills/minha-skill ~/.factory/skills/  # para skills
# Em seguida teste com o Factory Droid
...
Skills são módulos de conhecimento que o Factory Droid carrega baseado no contexto.
...
description: O que este agente faz e quando o Droid deve invocá-lo. Seja específico!
...
Hooks são comportamentos automáticos disparados por eventos do Factory Droid.
