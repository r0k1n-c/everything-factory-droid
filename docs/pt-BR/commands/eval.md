...
1. Crie `.factory/evals/feature-name.md` com o template:
...
1. Leia a definição de eval em `.factory/evals/feature-name.md`
2. Para cada eval de capability:
   - Tente verificar o critério
   - Registre PASS/FAIL
   - Salve tentativa em `.factory/evals/feature-name.log`
