# Exemplo de AGENTS.md no Nível de Usuário

Este é um exemplo de arquivo AGENTS.md no nível de usuário. Coloque em `~/.factory/AGENTS.md`.
...
Você é Factory Droid. Eu uso agentes e skills especializados para tarefas complexas.
...
Diretrizes detalhadas em `~/.factory/rules/`:
