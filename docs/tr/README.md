...
> **Factory Droid odaklı** | **47 agent** | **178 skill** | **76 command** | **Çapraz platform installer'lar**
...
**Bu kadar!** Artık 47 agent, 178 skill ve 76 command'a erişiminiz var.
...
|---------------------|---------------------|------------------|
| Yeni bir feature planla | `/plan "Auth ekle"` | planner |
| Sistem mimarisi tasarla | `/plan` + architect agent | architect |
...
```
/plan "OAuth ile kullanıcı kimlik doğrulaması ekle"
