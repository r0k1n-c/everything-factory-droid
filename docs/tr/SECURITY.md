...
EFD'de bir güvenlik açığı keşfederseniz, lütfen sorumlu bir şekilde bildirin.

**Güvenlik açıkları için herkese açık GitHub issue açmayın.**

Bunun yerine, [security@efd.tools](mailto:security@efd.tools) adresine aşağıdaki bilgilerle e-posta gönderin:
