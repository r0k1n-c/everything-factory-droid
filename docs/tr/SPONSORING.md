...
EFD, açık kaynaklı bir Factory Droid iş akışı sistemi olarak sürdürülmektedir.
...
- Factory Droid iş akışları için bakım, doğrulama ve paketleme çalışması
...
| Growth Partner | $500/ay | EFD'yi aktif olarak benimseyen ekipler | Pilot avantajları + aylık ofis saatleri senkronizasyonu + iş akışı entegrasyon rehberliği |
...
- Proje sitesi: [https://efd.tools](https://efd.tools)
