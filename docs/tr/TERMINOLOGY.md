...
| EFD Tools | EFD Tools | - | Ürün adı korunur |
...
6. **EFD Terimleri**: İngilizce tutulur (agent, hook, skill, command, rule, harness)
...
3. **Dokümantasyon uyumu**: Orijinal Factory Droid dokümantasyonu ve topluluk kaynaklarıyla uyum için İngilizce terimler korunur.
