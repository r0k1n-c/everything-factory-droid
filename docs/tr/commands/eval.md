...
1. Şablonla `.factory/evals/feature-name.md` oluştur:
...
1. `.factory/evals/feature-name.md` dosyasından eval tanımını oku
2. Her capability eval için:
   - Kriteri doğrulamayı dene
   - PASS/FAIL kaydet
   - Denemeyi `.factory/evals/feature-name.log` dosyasına kaydet
