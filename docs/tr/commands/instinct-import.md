...
5. İçgüdüleri inherited dizinine kaydet:
   - Proje kapsamı: `~/.factory/homunculus/projects/<project-id>/instincts/inherited/`
   - Global kapsam: `~/.factory/homunculus/instincts/inherited/`
...
New instincts saved to: ~/.factory/homunculus/instincts/inherited/
