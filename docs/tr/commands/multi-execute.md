...
1. **Input Tipini Tanımla**:
   - Plan dosya yolu (örn., `.factory/plan/xxx.md`)
...
1. Gemini'yi çağır (`~/.factory/.ccg/prompts/gemini/frontend.md` kullan)
...
1. Codex'i çağır (`~/.factory/.ccg/prompts/codex/architect.md` kullan)
2. Input: Plan içeriği + alınan context + hedef dosyalar
3. OUTPUT: `Unified Diff Patch ONLY. Strictly prohibit any actual modifications.`
