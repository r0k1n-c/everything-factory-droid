...
- **Sadece Planlama**: Bu komut context okumaya ve `.factory/plan/*` plan dosyalarına yazmaya izin verir, ancak **ASLA production kodu değiştirmez**
...
**ace-tool MCP mevcut DEĞİLSE**, fallback olarak Factory Droid built-in tool'ları kullan:
...
2. Planı `.factory/plan/<feature-name>.md`'ye kaydet (requirement'tan feature adını çıkar, örn., `user-auth`, `payment-module`)
3. **Kalın metinle** prompt çıktıla (MUTLAKA gerçek kaydedilen dosya yolunu kullan):

   ---
**Plan oluşturuldu ve `.factory/plan/actual-feature-name.md` dosyasına kaydedildi**
...
- **İlk planlama**: `.factory/plan/<feature-name>.md`
- **İterasyon versiyonları**: `.factory/plan/<feature-name>-v2.md`, `.factory/plan/<feature-name>-v3.md`...
...
2. `.factory/plan/<feature-name>.md` dosyasını güncelle
