...
- **Droid (self)** – Orkestrasyon, planlama, execution, teslimat
...
**Claude Sentezi**: Codex backend planı + Gemini frontend planını benimsle, kullanıcı onayından sonra `.factory/plan/task-name.md`'ye kaydet.
