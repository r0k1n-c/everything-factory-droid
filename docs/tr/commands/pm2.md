...
4. `.factory/commands/` dizininde komut dosyaları oluştur
5. `.factory/scripts/` dizininde script dosyaları oluştur
6. **Proje AGENTS.md'yi PM2 bilgisiyle güncelle** (aşağıya bakın)
7. **Terminal komutlarıyla tamamlama özetini göster**

---

## Post-Init: AGENTS.md'yi Güncelle

Dosyalar oluşturulduktan sonra, projenin `AGENTS.md` dosyasına PM2 bölümünü ekle (yoksa oluştur):
...
**Droid Commands:** /pm2-all, /pm2-all-stop, /pm2-{port}, /pm2-{port}-stop, /pm2-logs, /pm2-status
