---
description: Factory Droid session geçmişini, aliasları ve session metadata'sını yönet.
---

# Sessions Komutu

Factory Droid session geçmişini yönet - `~/.factory/session-data/` dizinindeki session'ları listele, yükle, alias ata ve düzenle.
...
- Session'lar markdown olarak `~/.factory/session-data/` dizininde saklanır
- Aliaslar `~/.factory/session-aliases.json` dosyasında saklanır
