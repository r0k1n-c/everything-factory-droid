...
Repository'nizin git geçmişini analiz ederek kodlama desenlerini çıkarın ve Droid'e ekibinizin uygulamalarını öğreten SKILL.md dosyaları oluşturun.
...
3. **SKILL.md Oluşturur** - Geçerli Factory Droid skill dosyaları oluşturur
