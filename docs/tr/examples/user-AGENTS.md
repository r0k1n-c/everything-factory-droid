# Kullanıcı Seviyesi AGENTS.md Örneği

Bu, örnek bir kullanıcı seviyesi AGENTS.md dosyasıdır. `~/.factory/AGENTS.md` konumuna yerleştirin.
...
Sen Factory Droid'sun. Karmaşık görevler için özelleşmiş agent'lar ve skill'ler kullanıyorum.
...
Detaylı yönergeler `~/.factory/rules/` içinde:
...
`~/.factory/droids/` konumunda bulunur:
