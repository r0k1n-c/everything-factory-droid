...
description: Factory Droid oturumlarından yeniden kullanılabilir kalıpları otomatik olarak çıkarın ve gelecekte kullanmak üzere öğrenilmiş skill'ler olarak kaydedin.
origin: EFD
---

# Sürekli Öğrenme Skill'i

Factory Droid oturumlarını sonunda otomatik olarak değerlendirir ve öğrenilmiş skill'ler olarak kaydedilebilecek yeniden kullanılabilir kalıpları çıkarır.

## Ne Zaman Aktifleştirmelisiniz

- Factory Droid oturumlarından otomatik kalıp çıkarma ayarlarken
- Oturum değerlendirmesi için Stop hook'u yapılandırırken
- `~/.factory/skills/learned/` içindeki öğrenilmiş skill'leri incelerken veya düzenlerken
...
3. **Skill Çıkarma**: Yararlı kalıpları `~/.factory/skills/learned/` dizinine kaydeder
...
```json
{
  ...
  "auto_approve": false,
  "learned_skills_path": "~/.factory/skills/learned/",
  "patterns_to_detect": [
    "error_resolution",
    "user_corrections",
    "workarounds",
