# 貢獻 Everything Factory Droid

感謝您想要貢獻。本儲存庫旨在成為 Factory Droid 使用者的社群資源。
...
```bash
git clone https://github.com/YOUR_USERNAME/everything-factory-droid.git
...
在提交前確保您的設定能與 Factory Droid 正常運作。
