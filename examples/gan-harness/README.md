...
```bash
# In Factory Droid interactive mode:
...
droid exec --model claude-opus-4-6 "$(cat agents/gan-planner.md)
...
droid exec --model claude-opus-4-6 "$(cat agents/gan-generator.md)
...
droid exec --model claude-opus-4-6 "$(cat agents/gan-evaluator.md)
