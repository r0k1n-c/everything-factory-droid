...
This is an example user-level AGENTS.md file. Place at `~/.factory/AGENTS.md`.
...
You are Factory Droid. I use specialized agents and skills for complex tasks.
...
Detailed guidelines are in `~/.factory/rules/`:
