...
cp -r rules/common ~/.factory/rules/common

# Install language-specific rules based on your project's tech stack
cp -r rules/typescript ~/.factory/rules/typescript
cp -r rules/python ~/.factory/rules/python
cp -r rules/golang ~/.factory/rules/golang
cp -r rules/web ~/.factory/rules/web
cp -r rules/swift ~/.factory/rules/swift
cp -r rules/php ~/.factory/rules/php
