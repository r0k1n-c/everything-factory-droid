...
const STRUCTURED_DIRS = /(^|\/)(docs|\.factory|\.github|commands|skills|benchmarks|templates|\.history|memory)\//;
  ...
  if (filePath && isSuspiciousDocPath(filePath)) {
    return {
      ...
      stderr:
        ...
        `[Hook] File: ${filePath}\n` +
        '[Hook] Consider using a structured path (e.g. docs/, .factory/, skills/, .github/, benchmarks/, templates/)',
    };
  }
