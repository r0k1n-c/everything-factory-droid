 ...
 *
 * Runs when a new Factory Droid session starts. Loads the most recent session
 * summary into Droid's context via stdout, and reports available
...
async function main() {
  ...
  reportLegacyMigrationErrors(migrateLegacySessions(), 'SessionStart');
  ...
  if (observerSessionId) {
    ...
    log('[SessionStart] No FACTORY_SESSION_ID available; skipping observer lease registration');
  }
