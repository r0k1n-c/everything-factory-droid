...
const SUPPORTED_INSTALL_TARGETS = ['factory-droid'];
...
function resolveLegacyCompatibilitySelection(options = {}) {
  ...
  const baseModuleIds = LEGACY_COMPAT_BASE_MODULE_IDS_BY_TARGET[target || 'factory-droid']
    || LEGACY_COMPAT_BASE_MODULE_IDS_BY_TARGET['factory-droid'];
