 ...
 *
 * Detection priority:
 * 1. FACTORY_DROID_PACKAGE_MANAGER environment variable
 * 2. Project-specific config (.factory/package-manager.json)
 * 3. package.json `packageManager` field
 * 4. Lock file detection
 * 5. Global user preference (~/.factory/package-manager.json)
 ...
 * Saves to ~/.factory/package-manager.json.
 ...
 * Saves to <projectDir>/.factory/package-manager.json.
