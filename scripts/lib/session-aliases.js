/**
 * Session Aliases Library for Factory Droid
 * Manages session aliases stored in ~/.factory/session-aliases.json
 */
...
function getAliasesPath() {
  return path.join(getFactoryDir(), 'session-aliases.json');
}
