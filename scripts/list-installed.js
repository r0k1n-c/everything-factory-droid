...
Inspect EFD install-state files for the current home/project context.
`);
...
function printHuman(records) {
  if (records.length === 0) {
    console.log('No EFD install-state files found for the current home/project context.');
    return;
  }

  console.log('Installed EFD targets:\n');
