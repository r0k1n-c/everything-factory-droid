...
Use this skill when a repo needs a project-specific EFD surface instead of the default full install.

The goal is not to guess what "feels useful." The goal is to classify EFD components with evidence from the actual codebase.

## When to Use

- A project only needs a subset of EFD and full installs are too noisy
...
- Prefer EFD-native surfaces; do not introduce a second install system
...
- DAILY skills -> install or keep in `.factory/skills/`
...
- `.factory/skills/skill-library/SKILL.md`
