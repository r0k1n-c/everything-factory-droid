...
5. If site copy matters, include the current EFD landing page and repo/plugin framing.
...
If the user wants Affaan / EFD voice and live sources are thin, start here unless newer source material overrides it:
