---
name: claude-api
description: Anthropic Claude API patterns for Python and TypeScript: Messages API, streaming, tool use, vision, extended thinking, batches, caching, and Agent SDK.
origin: EFD
---
