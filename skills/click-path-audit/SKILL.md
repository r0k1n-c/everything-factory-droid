...
description: Trace UI touchpoints through state change sequences to find bugs where functions cancel each other out or leave inconsistent state. Use after refactors touching shared state.
origin: community
