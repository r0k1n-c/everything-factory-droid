...
Systematically analyze an unfamiliar codebase and produce a structured onboarding guide. Designed for developers joining a new project or setting up Factory Droid in an existing repo for the first time.

## When to Use

- First time opening a project with Factory Droid
