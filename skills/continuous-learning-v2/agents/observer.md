...
A background agent that analyzes observations from Factory Droid sessions to detect patterns and create instincts.
...
- Project: `~/.factory/homunculus/projects/<project-hash>/observations.jsonl`
- Global fallback: `~/.factory/homunculus/observations.jsonl`
...
- Project: `~/.factory/homunculus/projects/<project-hash>/instincts/personal/`
- Global: `~/.factory/homunculus/instincts/personal/` (for universal patterns)
