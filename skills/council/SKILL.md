...
- the in-context Factory Droid voice
- a Skeptic subagent
...
Do **not** write ad-hoc notes to `~/.factory/notes` or other shadow paths from this skill.
...
```text
Should we ship EFD 2.0 as alpha now, or hold until the control-plane UI is more complete?
```
