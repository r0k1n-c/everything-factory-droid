...
description: Build automated data collection agents for any public source. Schedules scraping via GitHub Actions, enriches with LLM, stores in Notion/Sheets/Supabase.
origin: community
