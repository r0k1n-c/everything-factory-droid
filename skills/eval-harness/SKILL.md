...
A formal evaluation framework for Factory Droid sessions, implementing eval-driven development (EDD) principles.

## When to Activate

- Setting up eval-driven development (EDD) for AI-assisted workflows
- Defining pass/fail criteria for Factory Droid task completion
...
### Capability Evals
Test if Droid can do something it couldn't before:
```markdown
...
- `docs/evals/<version>/summary.md` release snapshot
