---
name: exa-search
description: Neural search via Exa MCP for web, code, and company research. Use for web search, code examples, company intel, or AI-powered deep research.
origin: EFD
...
Exa MCP server must be configured. Add to `~/.factory/settings.json`:
