---
name: fal-ai-media
description: Generate images, video, and audio via fal.ai MCP: Nano Banana, Seedance, Kling, Veo 3, CSM-1B, ThinkSound.
origin: EFD
...
fal.ai MCP server must be configured. Add to `~/.factory/settings.json`:
