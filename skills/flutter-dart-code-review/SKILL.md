...
description: Library-agnostic Flutter/Dart code review: widgets, state management (BLoC, Riverpod, Provider, GetX, MobX, Signals), performance, accessibility, and security.
origin: EFD
---
