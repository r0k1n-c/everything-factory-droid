...
description: Clinical Decision Support patterns: drug interaction checking, dose validation, clinical scoring (NEWS2, qSOFA), alert classification, and EMR integration.
