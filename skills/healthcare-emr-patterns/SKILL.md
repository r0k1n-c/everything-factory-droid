...
description: EMR/EHR development patterns: clinical safety, encounter workflows, prescription generation, CDSS integration, and accessibility-first medical data UI.
