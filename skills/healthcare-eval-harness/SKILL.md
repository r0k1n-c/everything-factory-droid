...
description: Patient safety evaluation for healthcare deployments: CDSS accuracy, PHI exposure, clinical workflow integrity, and integration compliance tests.
