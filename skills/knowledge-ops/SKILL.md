...
### Layer 2: Factory Droid Memory (Quick Access)
- **Path:** `~/.factory/projects/*/memory/`
...
- Always update Factory Droid memory for quick access
...
- Factory Droid/ChatGPT/Grok conversation exports
- Browser bookmarks
