...
description: Triage issues and PRs across GitHub and Linear, link active work, and coordinate public GitHub with internal Linear execution.
origin: EFD
...
| Port/Rebuild | useful idea, but should be manually re-landed inside EFD |
...
- External-source features should be rebuilt inside EFD when they are valuable but not self-contained
...
- "Map GitHub issues into our EFD 1.x and EFD 2.0 program lanes"
