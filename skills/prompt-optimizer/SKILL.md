...
description: Analyze and optimize prompts, match EFD components, output ready-to-paste results. Advisory only — never executes. Triggers on "optimize/improve/rewrite prompt". Not for "optimize code/performance".
origin: community
metadata:
  author: YannJY02
  version: "1.0.0"
...
Analyze a draft prompt, critique it, match it to EFD ecosystem components,
...
- User says "what's the best way to ask Factory Droid to..."
- User says "优化prompt", "改进prompt", "怎么写prompt", "帮我优化这个指令"
- User pastes a draft prompt and asks for feedback or enhancement
- User says "I don't know how to prompt for this"
- User says "how should I use EFD for..."
...
- User is asking about EFD configuration (use `configure-efd` instead)
...
### Phase 3: EFD Component Matching

Map intent + scope + tech stack (from Phase 0) to specific EFD components.
...
### Section 2: Recommended EFD Components
...
A compact version for experienced EFD users. Vary by intent type:
...
- "Optimize this prompt for EFD"
- "Rewrite this prompt so Factory Droid uses the right commands"
- "帮我优化这个指令"
- "How should I prompt EFD for this task?"
...
|-----------|------------------|
| `configure-efd` | User hasn't set up EFD yet |
