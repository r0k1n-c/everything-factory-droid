...
description: Weighted social-graph ranking for warm intro discovery, bridge scoring, and network gap analysis on X and LinkedIn. The reusable engine, not the outreach layer.
origin: EFD
