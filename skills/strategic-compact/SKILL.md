...
```json
{
  "hooks": {
    "PreToolUse": [
      {
        "matcher": "Edit",
        "hooks": [{ "type": "command", "command": "node ~/.factory/skills/strategic-compact/suggest-compact.js" }]
      },
      {
        "matcher": "Write",
        "hooks": [{ "type": "command", "command": "node ~/.factory/skills/strategic-compact/suggest-compact.js" }]
...
| Memory files (`~/.factory/memory/`) | Multi-step conversation context |
...
- Same rules in both `~/.factory/rules/` and project `.factory/rules/`
