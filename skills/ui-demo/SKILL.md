---
name: ui-demo
description: Record polished UI demo videos using Playwright with visible cursor and natural pacing. Use for demos, walkthroughs, or tutorials of web apps.
origin: EFD
