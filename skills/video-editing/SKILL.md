---
name: video-editing
description: AI-assisted video editing: cutting, structuring, and augmenting footage via FFmpeg, Remotion, ElevenLabs, fal.ai, Descript, or CapCut.
origin: EFD
...
## Layer 2: Organization (Factory Droid)

Use Factory Droid to:
...
|------|----------|----------|
| Factory Droid | Organization, planning, code generation | Not the creative taste layer |
