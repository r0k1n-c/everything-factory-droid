...
function inTempRepo(fn) {
  ...
  try {
    ...
    spawnSync('git', ['config', 'user.name', 'EFD Test'], { cwd: repoDir, stdio: 'pipe', encoding: 'utf8' });
    spawnSync('git', ['config', 'user.email', 'efd@example.com'], { cwd: repoDir, stdio: 'pipe', encoding: 'utf8' });
